...
**The source.** 75 modules under `src/`. Calculation modules remain
...
**The checks.** 3,532 tests across 121 files, 21 ProcureBench evaluation cases,
...
- That ProcureBench passing means the analysis is correct. It means the
  ...
  the same goes for 3,532 tests: they say the code does what it was written to
