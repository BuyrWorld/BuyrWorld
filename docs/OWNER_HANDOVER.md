...
**The source.** 69 modules under `src/`. Calculation modules remain
...
**The checks.** 3,295 tests across 112 files, 21 ProcureBench evaluation cases,
...
- That ProcureBench passing means the analysis is correct. It means the
  ...
  the same goes for 3,295 tests: they say the code does what it was written to
