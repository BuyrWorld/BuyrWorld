...
211 tests, 21 ProcureBench cases, five verification checks, all run by CI.
...
### 4. Phase 6 — UX and accessibility

Nothing has been done here. The hard part is evidence and confidence states: a
figure must *look* different depending on whether it is supplied, derived or
assumed, without the interface becoming noisy. Target WCAG 2.2 AA. Test tables,
exports and keyboard paths.
